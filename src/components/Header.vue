    ...
    <ul class="navbar-nav ml-auto">
        ...
        >
          ...
          <a class="dropdown-item d-flex align-items-center" href="#">
            <div class="dropdown-list-image mr-3">
              <img
                class="rounded-circle"
                src="https://i.pravatar.cc/200?u=1"
                alt=""
              />
          ...
          <a class="dropdown-item d-flex align-items-center" href="#">
            <div class="dropdown-list-image mr-3">
              <img
                class="rounded-circle"
                src="https://i.pravatar.cc/200?u=2"
                alt=""
              />
          ...
          <a class="dropdown-item d-flex align-items-center" href="#">
            <div class="dropdown-list-image mr-3">
              <img
                class="rounded-circle"
                src="https://i.pravatar.cc/200?u=3"
                alt=""
              />
              <div class="status-indicator bg-success" />
            </div>
      ...
      <li class="nav-item dropdown no-arrow">
        <a
          ...
          aria-expanded="false"
        >
          <span class="mr-2 d-none d-lg-inline text-gray-600" v-if="user">{{
            user.first_name + " " + user.last_name
          }}</span>
          <img
            class="img-profile rounded-circle"
            src="https://i.pravatar.cc/200?u=your_profile"
            alt=""
          />
        </a>
